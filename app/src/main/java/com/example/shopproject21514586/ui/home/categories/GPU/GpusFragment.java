package com.example.shopproject21514586.ui.home.categories.GPU;
...
public class GpusFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        DatabaseReference ref = database.getReference("Products").child("GPU");
